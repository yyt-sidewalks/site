...
function makestories(c) {
	...
	$.each(randomkeys, function (k, v) {
		...
		$('#stories_' + String(col)).append('<div class="storybox message"><div class="message-body"><h5>' + storyoptions.type[thisstory.type] + ' - ' + dateinfo.join(' ') + '</h5><h6>' + thisstory.who + ' &#183; ' + thisstory.nicedate + '</h6><p>' + description + '</p><p><a href="https://yyt-sidewalks.github.io/site/stories/?story=' + thisstory.identifier + '">Read More</a></p></div></div>');
		if (p >= l) {
			col++;
			p = 0;
		}
